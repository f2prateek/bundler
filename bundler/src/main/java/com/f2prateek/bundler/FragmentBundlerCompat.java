 ...
 *
 * Usage: {@code Fragment fragment = FragmentBundlerCompat.make(FooFragment.class).put(....)..build();}
 *
...
public class FragmentBundlerCompat<F extends Fragment> {
     ...
     * @return this bundler instance to chain method calls
     */
    public FragmentBundlerCompat<F> putCharSequenceArrayList(String key, ArrayList<CharSequence> value) {
